...
exports.sendGroupInviteEmail = void 0;
 ...
 */
const generateInviteEmailHTML = (data) => {
    return `
<!DOCTYPE html>
<html lang="en">
<head>
 ...
 */
const generateInviteEmailText = (data) => {
    return `
 ...
 */
exports.sendGroupInviteEmail = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        return { success: true, messageId: emailData === null || emailData === void 0 ? void 0 : emailData.id };
    }
    catch (error) {
